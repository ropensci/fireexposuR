...
fire_exp_map(exposure_long, area_of_interest, classify = "local")

# Visualize long-range ember exposure classes to values in summary table
fire_exp_extract_summary(values_exposure_long, classify = "local")

# Visualize long-range ember exposure classes to values in map
fire_exp_extract_map(values_exposure_long, classify = "local")

# Repeat the visualizations for short-range ember exposure
fire_exp_summary(exposure_short, area_of_interest, classify = "local")
fire_exp_map(exposure_short, area_of_interest, classify = "local")
fire_exp_extract_summary(values_exposure_short, classify = "local")
fire_exp_extract_map(values_exposure_short, classify = "local")
```
